...
import { getLobby, updateLobbyStatus } from '../actions/lobbyActions';
import { Link } from 'react-router-dom';
import isObjNotEmpty from '../helpers';
import TimeAgo from 'timeago-react';

const LobbyContainer = ({ lobby, getLobby, updateLobbyStatus, currentUser, match, loading }) => {
    useEffect(() => {
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        updateLobbyStatus: (id) => dispatch(updateLobbyStatus(id)),
    }
}
